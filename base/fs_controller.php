...
class fs_controller
{
   ...
   public function __construct($name = '', $title = 'home', $folder = '', $admin = FALSE, $shmenu = TRUE, $important = FALSE)
   {
      ...
      {
         $this->new_error_msg('El sistema
          necesita PHP 5.3 o superior, y tú tienes PHP '.phpversion().'.');
      }
   ...
   /**
    * Devuelve la versión de 
    * @return type versión de 
    */
