...
class fs_updater
{
   ...
   public function __construct()
   {
      ...
      if( isset($_COOKIE['user']) AND isset($_COOKIE['logkey']) )
      {
         ...
         if($this->errores == '')
         {
            ...
            $nueva_version = @$this->curl_get_contents('https://raw.githubusercontent.com/sartin1/tecnopolis/master/VERSION');
   ...
   {
      $urls = array(
          'https://github.com/sartin1/tecnopolis/archive/master.zip',
          'https://codeload.github.com/sartin1/tecnopolis/zip/master'
      );
      ...
      foreach($urls as $url)
      {
         if( @file_put_contents('update.zip', $this->curl_get_contents($url)) )
         {
            ...
            if($zip_status === TRUE)
            {
               ...
               $this->recurse_copy('tecnopolis-master/', '.');
               $this->delTree('tecnopolis-master/');
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es" xml:lang="es" >
   <head>
      ...
      <title>Actualizador de sistema</title>
      <meta name="description" content="Script de actualización de Tecnopolis." />
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      <meta name="generator" content="Tecnopolis" />
