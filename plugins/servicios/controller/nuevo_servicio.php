...
class nuevo_servicio extends fs_controller
{
   ...
   {
      parent::__construct(__CLASS__, 'Nuevo Turno...', 'ventas', FALSE, FALSE, TRUE);
   }
   ...
   private function nuevo_servicio_cliente()
   {
      ...
      if($continuar)
      {
         ...
         $servicio->telefonocli = $cliente->telefono1;
         ...
         {
            $servicio->presupre = $_POST['presupre'];
         }
         if( isset($_POST['repuesto']) )
         {
            $servicio->repuesto = $_POST['repuesto'];
         }
         ...
         if( $servicio->save() )
         {
            ...
            if($continuar)
            {
               ...
               else if( $servicio->save() )
               {
                  ...
                  header('Location:index.php?page=imprimir_rapido_horizontal&id='.$servicio->idservicio);
               }
               else
