...
class empresa extends fs_model
{
   ...
   /**
    *
    * @var type Nombre a mostrar en el menú de .
    */
   public $nombrecorto;
   ...
   protected function install()
   {
      ...
      return "INSERT INTO ".$this->table_name." (stockpedidos,contintegrada,recequivalencia,codserie,"
              ...
              ."VALUES (NULL,FALSE,NULL,'A','ALG','CONT','ARS','0001','',"
              ."NULL,NULL,NULL,'ARG',NULL,NULL,NULL,NULL,'Direccion','',NULL,'00000000','Empresa ".$e." S.L.',"
              ."'E-".$e."','','');";
   }
