...
function guarda_config($nombre_archivo)
{
   ...
   if($archivo)
   {
      ...
      fwrite($archivo, " * Sartin conectadas al mismo servidor memcache.\n");
      fwrite($archivo, " */\n");
      fwrite($archivo, "\n");
...
$system_info = 'Sartin: '.file_get_contents('VERSION')."\n";
...
<head>
   ...
   <title>Sartin</title>
   <meta name="description" content="Sartin es un software de facturación y contabilidad para pymes. Es software libre bajo licencia GNU/LGPL." />
   ...
   <nav class="navbar navbar-default" role="navigation" style="margin: 0px;">
      <div class="container-fluid">
         <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">Sartin</a>
         </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-12">
            <div class="page-header">
               <h1>
                  Bienvenido al instalador de Sartin
         ...
         <div class="col-sm-12">
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     La carpeta de Sartin no tiene permisos de escritura. Sin esos
                     permisos, no funcionará Sartin.
                  </p>
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     Sartin necesita PHP 5.3 o superior, y tú estás usando <?php echo phpversion() ?>.
                  </p>
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     Sartin necesita la extensión mbstring para poder trabajar con caracteres
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     Sartin necesita la extensión OpenSSL para poder descargar plugins,
      ...
      <div class="row" style="margin-bottom: 20px;">
         <div class="col-sm-12 text-center">
            <hr/>
            <small>
               © 2016 <a target="_blank" href="">Miguel San martin</a>
            </small>
         </div>
      </div>
   </div>
