...
<div class="well">
   <div class="page-header" style="margin-top: 0px;">
      <h1>
         Bienvenido a Sartin Soft
         <small><?php echo $fsc->version();?></small>
      </h1>
   </div>
   <p class="help-block">
      Ya tienes instalado el sistema, que lo disfrutes :) .
   </p>
               ...
               <tr<?php if( !$value1['compatible'] ){ ?> class="danger"<?php }elseif( $value1['enabled'] ){ ?> class="success"<?php } ?>>
                  ...
                  <td class="text-right">
                     ...
                     <div class="btn-group">
                        ...
                        <a class="btn btn-sm btn-default" href="#" onclick="alert('Le falta el archivo Sartin.ini')">
